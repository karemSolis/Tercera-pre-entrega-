...
import ProductsController from "./products.controller.js"; 
    ...
    class CartController { /*Esta clase manejará todas las operaciones relacionadas con el carrito de compras*/
    constructor() {
        this.ProductsController = new ProductsController(); /*En el constructor se crea la instancia que se utilizará para realizar operaciones relacionadas con productos, esto quiere decir que creamos la 
    ...
    async getCartsById(cartId) {
        const cart = await this.ProductsController.exist(cartId);
    ...
    async getProductsForCart(productIds) {
        const products = await this.ProductsController.getProductById(productIds); /*hace referencia a la instancia productManager creada en el constructor arriba, 
    ...
    async addProductInCart(cartId, productId) { /*cartId, productId representan id de carrito y id de productos */
        ...
        const product = await this.ProductsController.exist(productId);
